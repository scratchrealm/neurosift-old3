import { SetProjectPropertyRequest, SetProjectPropertyResponse } from "../../src/types/NeurosiftRequest";
import getProject, { invalidateProjectCache } from '../getProject';
import { getMongoClient } from "../getMongoClient";
import getWorkspace from '../getWorkspace';
import { userCanSetProjectProperty } from "../permissions";

const setProjectPropertyHandler = async (request: SetProjectPropertyRequest, o: {verifiedUserId?: string}): Promise<SetProjectPropertyResponse> => {
