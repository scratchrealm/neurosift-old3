import { DuplicateProjectFileRequest, DuplicateProjectFileResponse } from "../../src/types/NeurosiftRequest";
...
const duplicateProjectFileHandler = async (request: DuplicateProjectFileRequest, o: {verifiedUserId?: string}): Promise<DuplicateProjectFileResponse> => {
