import { SetWorkspacePropertyRequest, SetWorkspacePropertyResponse } from "../../src/types/NeurosiftRequest";
...
const setWorkspacePropertyHandler = async (request: SetWorkspacePropertyRequest, o: {verifiedUserId?: string}): Promise<SetWorkspacePropertyResponse> => {
