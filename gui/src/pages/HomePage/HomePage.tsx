        ...
        <div className="homepage" style={{position: 'absolute', width, height, overflowY: 'auto'}}>
            <div style={{position: 'absolute', left: (width - W) / 2, width: W, border: 'solid 1px lightgray'}}>
                <div style={{padding: 20}}>
                    <h1 style={{textAlign: 'center'}}>Neurosift</h1>
                    <p style={{textAlign: 'center'}}>
                        Visualizations for Neuroscience. <Hyperlink onClick={() => setRoute({page: 'about'})}>Learn more...</Hyperlink>
                    </p>
                    <p>This software is in beta.</p>
                    <hr />
